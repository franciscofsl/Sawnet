...
internal class LocalStorageService : ILocalStorageService, ISyncLocalStorageService
{
    ...
    {
        return _storageProvider.ClearAsync(cancellationToken);
    }

    public ValueTask<int> LengthAsync(CancellationToken cancellationToken = default)
    {
        return _storageProvider.LengthAsync(cancellationToken);
    }

    public ValueTask<string> KeyAsync(int index, CancellationToken cancellationToken = default)
    {
        return _storageProvider.KeyAsync(index, cancellationToken);
    }

    public ValueTask<IEnumerable<string>> KeysAsync(CancellationToken cancellationToken = default)
    {
        return _storageProvider.KeysAsync(cancellationToken);
    }

    public ValueTask<bool> ContainKeyAsync(string key, CancellationToken cancellationToken = default)
    {
        return _storageProvider.ContainKeyAsync(key, cancellationToken);
    }

    public ValueTask RemoveItemsAsync(IEnumerable<string> keys, CancellationToken cancellationToken = default)
    {
        return _storageProvider.RemoveItemsAsync(keys, cancellationToken);
    }
    ...
    public void RemoveItems(IEnumerable<string> keys)
    {
        ...
        foreach (var key in keys) _storageProvider.RemoveItem(key);
    }
